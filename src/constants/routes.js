...
export const PAGE_SERVICES_DETAIL = '/services/:slug'
export const PAGE_CARS = '/cars/'
export const PAGE_CAR_DETAIL = '/cars/:slug'
...
export const PAGE_ARTICLE_DETAIL = '/article/:slug/'
